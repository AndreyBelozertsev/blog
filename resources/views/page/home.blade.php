                    ...
                    <div class="col-span-5 lg:col-span-3 order-3">
                        <div class="sm:grid grid-cols-4 2xl:grid-cols-2 ">
                            ...
                            <div class="col-span-3 2xl:col-span-1">
                                ...
                                <div>
                                    <a class="ff-Montserrat text-center text-base md:text-lg py-4 md:py-6 px-3 md:px-4 justify-between bg-accent leading-none" href="https://getcourse.ru/"><span class="pr-4">Получить видеоруководство</span>
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="grid lg:grid-cols-5">
                                    <div class="col-span-4 lg:col-span-4 lg:col-start-2">
                                        <a class="ff-Montserrat text-center text-xs xs:text-sm lg:text-lg py-4 md:py-6 px-3 md:px-4 bg-accent leading-none justify-between" href="https://getcourse.ru/"><span class="pr-2 sm:pr-4">Получить видеоруководство</span>
                                            <svg class="inline" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M15.9687 11.1881L15.9687 4.03116L12.3349 7.68389C13.6616 6.35013 15.9389 7.27978 15.9533 9.16098L15.9687 11.1881Z" fill="white"/>
                                                <path d="M15.9687 4.03116H11.1974H8.81176L10.827 4.03845C12.7252 4.04532 13.6736 6.33819 12.3349 7.68389L15.9687 4.03116Z" fill="white"/>
                                                <path d="M5.55424 14.4456L12.3349 7.68389M15.9687 4.03116L11.1974 4.03116L8.81176 4.03116M15.9687 4.03116L15.9687 11.1881M15.9687 4.03116L12.3349 7.68389M6.42612 4.03116L8.81176 4.03116M15.9687 13.5737L15.9687 11.1881M8.81176 4.03116L10.827 4.03845C12.7252 4.04532 13.6736 6.33819 12.3349 7.68389V7.68389M15.9687 11.1881L15.9533 9.16098C15.9389 7.27978 13.6616 6.35013 12.3349 7.68389V7.68389" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div class="container">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 2xl:grid-cols-5 pb-24 gap-12">
                    ...
                    <div class="sm:col-span-2 flex flex-col justify-center order-3 lg:order-2">
                        ...
                        <form id="contact-form" class="contact-form" action="{{ route('sendForm') }}">
                            <div class="pb-6">
                                <input name="name" class="w-full pb-4 pt-2 bg-transparent border-b placeholder:opacity-50 ff-Montserrat focus:outline-none" type="text" placeholder="Имя">
                                <span class="text-red-600 text-sm feedback-error" id="name-error"></span>
                            </div>
                            <div class="pb-6">
                                <input name="phone" class="phone-number w-full pb-4 pt-2 bg-transparent border-b placeholder:opacity-50 ff-Montserrat focus:outline-none" type="phone" placeholder="Телефон">
                            ...
                            <span class="text-red-600 text-sm feedback-error" id="agree-error"></span>
                            <div class="response"></div> 
                            <div>
                                <button type="submit" class="ff-Montserrat text-center text-lg py-6 bg-accent leading-none px-4 justify-between" href="https://getcourse.ru/"><span class="pr-4">Получить консультацию</span>
                                    <svg class="inline" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M15.9687 11.1881L15.9687 4.03116L12.3349 7.68389C13.6616 6.35013 15.9389 7.27978 15.9533 9.16098L15.9687 11.1881Z" fill="white"/>
                                        <path d="M15.9687 4.03116H11.1974H8.81176L10.827 4.03845C12.7252 4.04532 13.6736 6.33819 12.3349 7.68389L15.9687 4.03116Z" fill="white"/>
                                        <path d="M5.55424 14.4456L12.3349 7.68389M15.9687 4.03116L11.1974 4.03116L8.81176 4.03116M15.9687 4.03116L15.9687 11.1881M15.9687 4.03116L12.3349 7.68389M6.42612 4.03116L8.81176 4.03116M15.9687 13.5737L15.9687 11.1881M8.81176 4.03116L10.827 4.03845C12.7252 4.04532 13.6736 6.33819 12.3349 7.68389V7.68389M15.9687 11.1881L15.9533 9.16098C15.9389 7.27978 13.6616 6.35013 12.3349 7.68389V7.68389" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div class="border border-white xl:col-span-2 2xl:col-span-4">
                        <div class="p-8">
                            <div class="pb-10">
                                ...
                                <div class="grid grid-cols-5">
                                    <div class="col-span-5 lg:col-span-4 lg:col-start-2">
                                        <p class="text-xl lg:text-3xl xl:text-4xl 2xl:text-[40px] uppercase font-medium">к каналу</p>
                                    </div> 
                                </div>
                            </div>
                            <div class="flex flex-col">
                                <div class="grid lg:grid-cols-5 xl:grid-cols-2 2xl:grid-cols-5 gap-4">
                                    <div class="lg:col-span-3 xl:col-span-1 2xl:col-span-3 lg:col-start-2 xl:col-start-1 2xl:col-start-2 pb-10">
                                        <p class="ff-Montserrat">Напишите нашему боту и он Вам поможет получить доступ</p>
                                    </div> 
                                    ...
                                    <div class="lg:col-span-3 xl:col-span-5 2xl:col-span-3  lg:col-start-2 xl:col-start-1 2xl:col-start-2">
                                        <a class="block ff-Montserrat text-center text-center text-xs xs:text-sm lg:text-lg py-4 md:py-6 px-3 md:px-4 bg-accent leading-none justify-between" href="https://t.me/PapazzhukBot"><span class="pr-2 sm:pr-4">Написать боту</span>
                                            <svg class="inline" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M15.9687 11.1881L15.9687 4.03116L12.3349 7.68389C13.6616 6.35013 15.9389 7.27978 15.9533 9.16098L15.9687 11.1881Z" fill="white"/>
                                                <path d="M15.9687 4.03116H11.1974H8.81176L10.827 4.03845C12.7252 4.04532 13.6736 6.33819 12.3349 7.68389L15.9687 4.03116Z" fill="white"/>
                                                <path d="M5.55424 14.4456L12.3349 7.68389M15.9687 4.03116L11.1974 4.03116L8.81176 4.03116M15.9687 4.03116L15.9687 11.1881M15.9687 4.03116L12.3349 7.68389M6.42612 4.03116L8.81176 4.03116M15.9687 13.5737L15.9687 11.1881M8.81176 4.03116L10.827 4.03845C12.7252 4.04532 13.6736 6.33819 12.3349 7.68389V7.68389M15.9687 11.1881L15.9533 9.16098C15.9389 7.27978 13.6616 6.35013 12.3349 7.68389V7.68389" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
